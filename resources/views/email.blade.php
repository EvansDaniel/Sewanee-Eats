...
<div class="title" style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:600;color:#374550">Delivery confirmation</div>
<br>
  ...
  <br><br>
        ...
        <tr>
          <td class="container-padding footer-text" align="left" style="font-family:Helvetica, Arial, sans-serif;font-size:12px;line-height:16px;color:#aaaaaa;padding-left:24px;padding-right:24px">
            ...
            You are receiving this email because you used sewaneeEats.com Services.
            ...
            <a href="http://www.sewaneeEats.com" style="color:#aaaaaa">www.sewaneeEats.com</a><br>
