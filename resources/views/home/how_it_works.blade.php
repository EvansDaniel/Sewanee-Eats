...
@section('body')
    ...
    <p style="width:50%; padding: 0 15 0 50">Click the Checkout link in the top right corner and you will be directed to
    ...
    <p style="width:50%; padding: 0 15 0 50">To pay with Venmo, leave your Venmo username in the empty box and click 'Submit'. We will immediately send you a request on Venmo
        for the amount listed as your order total. Once you have paid, you are good to go!</p>

    <h3>Pay with Card</h3>

    <p style="width:50%; padding: 0 15 0 50">
    We accept all major debit and credit cards. Simply enter your information and click 'Submit'. Our payment processor is
    secure and all your information is safe. We process all card payments using <a href="https://www.stripe.com">Stripe</a>, a secure payment processor.
    </p>

    <h2>I've paid, now what?</h2>
    <p style="width:50%; padding: 0 15 0 50">
    Once you have paid for your order, you will receive an email receipt from Sewanee Eats confirming your order. One of our delivery
